...
const KEYS = ["clients", "shippings", "invoices", "snapshots", "catalog", "prices", "times", "lista", "ledger", "suppliers", "aliases"];
...
export default async function handler(req, res) {
  ...
  try {
    if (req.method === "GET") {
      ...
      const out = { configured: true, clients: [], shippings: [], invoices: [], snapshots: [], catalog: [], prices: {}, times: {}, lista: {}, ledger: [], suppliers: [], aliases: {} };
