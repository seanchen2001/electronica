...
export const CATALOG = [
  { cat: "Samsung baja gama", name: "A06 4+64 DS" },
  { cat: "Samsung baja gama", name: "A07 4+64 DS" },
  { cat: "Samsung baja gama", name: "A07 4+128 DS" },
  { cat: "Samsung baja gama", name: "A16 4+128 DS" },
  { cat: "Samsung baja gama", name: "A17 4+128 DS" },
  { cat: "Samsung baja gama", name: "A26 8+256 5G DS" },
  { cat: "Samsung baja gama", name: "A36 6+128 5G DS" },
  { cat: "Samsung baja gama", name: "A36 8+256 5G DS" },
  { cat: "Samsung baja gama", name: "A37 6+128 5G DS" },
  { cat: "Samsung baja gama", name: "A37 8+256 5G DS" },
  { cat: "Samsung baja gama", name: "A56 8+128 5G DS" },
  { cat: "Samsung baja gama", name: "A56 8+256 5G DS" },
  { cat: "Samsung baja gama", name: "A56 12+256 5G DS" },
  { cat: "Samsung baja gama", name: "A57 8+128 5G DS" },
  { cat: "Samsung baja gama", name: "A57 8+256 5G DS" },
  { cat: "Samsung baja gama", name: "A57 12+256 5G DS" },
  { cat: "Samsung alta gama", name: "S25 FE 8+256 5G DS" },
  { cat: "Samsung alta gama", name: "S25 FE 8+512 5G DS" },
  { cat: "Samsung alta gama", name: "S25 Ultra 12+256 5G DS" },
  { cat: "Samsung alta gama", name: "S25 Ultra 12+512 5G DS" },
  { cat: "Samsung alta gama", name: "S25 Ultra 12+1024 5G DS" },
  { cat: "Samsung alta gama", name: "S26 12/256GB 5G" },
  { cat: "Samsung alta gama", name: "S26 12/512GB 5G" },
  { cat: "Samsung alta gama", name: "S26 Plus 12/256GB 5G" },
  { cat: "Samsung alta gama", name: "S26 Plus 12/512GB 5G" },
  { cat: "Samsung alta gama", name: "S26 ULTRA 12/256GB 5G" },
  { cat: "Samsung alta gama", name: "S26 ULTRA 12/512GB 5G" },
  { cat: "Samsung alta gama", name: "S26 ULTRA 12/1TB 5G" },
  ...
  { cat: "Motorola LATIN", name: "Motorola G86 POWER 8+256" },
