...
export function buildAgentSystem({ catalogNames, suppliers, clientNames }) {
  return [
    ...
    "- 'cotizá' con PRECIOS SUGERIDOS por el cliente (texto o imagen tipo tabla producto/cantidad/precio) = COMPARAR: llamá quote_analysis pasando clientPrice por modelo, y respondé cuáles podemos igualar, el margen % que deja cada precio sugerido, y cuáles conviene mejorar (o están por debajo del costo). No armes orden salvo que lo pidan.",
