...
export function buildAgentSystem({ catalogNames, suppliers, clientNames, shippingNames, learned }) {
  return [
    ...
    "  IMEIs: los IMEI son UNO POR UNIDAD, agrupados por modelo. Si el usuario pega un bloque de IMEIs para una factura, cargalos con load_imeis (invoiceNo + assignments por modelo). Confirmá cuántos cargaste por línea (cargados/esperados) y si algún modelo no matcheó. Al completarse, el checkpoint 'IMEIs' se cierra solo.",
