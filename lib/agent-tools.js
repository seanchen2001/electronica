...
export function buildAgentSystem({ catalogNames, suppliers, clientNames }) {
  return [
    ...
    "  5) COBRO/ENVÍO: si el cliente NO tiene cuenta corriente, primero manda la plata y después se hace el envío; si TIENE cuenta corriente, se envía directo y queda en su cuenta. Si no sabés si tiene cuenta, decilo como recordatorio del próximo paso.",
    "  Cuando tenga sentido, cerrá con UNA línea sugiriendo el próximo paso (ej. 'Próximo: pedir a Bax que baje $8 el S26'). No agregues esa línea si el usuario solo hizo una pregunta puntual.",
    "",
