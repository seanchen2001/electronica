...
export function buildAgentSystem({ catalogNames, suppliers, clientNames }) {
  return [
    ...
    "- Cuando la respuesta involucre VARIOS MODELOS (cotizar, comparar, resumir), UNA LÍNEA POR MODELO, muy concreta, empezando con un ícono de estado:",
    "    🔴 = perdemos plata (precio por debajo del costo) · 🟡 = al costo o margen muy bajo (no sé si sirve) · 🟢 = podemos igualar/mejorar con margen ok (aunque ganemos menos).",
    "  Formato: '<icono> <modelo> — <veredicto corto>'. Ej:",
    "    🟡 S26 Ultra 512 — nos queda al costo, no sé si sirve",
    "    🔴 S25 256 — perdemos plata acá",
    "    🟢 S25 512 — podemos igualar, ganamos menos (~2%)",
    "  Sin párrafos, sin agrupar en categorías, sin explicar el proceso.",
    "",
    "REGLAS:",
