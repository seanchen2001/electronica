...
export function buildAgentSystem({ catalogNames, suppliers, clientNames, shippingNames }) {
  return [
    ...
    "- TODO BORRADO (pedido, factura, cliente, envío, proveedor) pide CONFIRMACIÓN al usuario en un modal antes de ejecutarse: los tools devuelven 'needs_confirmation'. No hace falta que preguntes vos aparte por texto — con avisar que quedó a la espera de confirmación alcanza.",
    "",
