...
// Las Mac van en Apple; "Laptops" es para las que no son Apple (Dell/HP/Lenovo/…).
export const DEPTS = ["Apple", "Samsung", "Motorola", "Laptops", "Gaming", "Otros"];
...
export const DEPT_BY_CAT = {
  ...
  "Dell": "Laptops", "HP": "Laptops", "Lenovo": "Laptops", "Samsung Laptops": "Laptops",
